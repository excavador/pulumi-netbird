...
import (
	...
	"github.com/excavador/pulumi-netbird/provider/resource"
...
func Provider() p.Provider { //nolint:funlen
	...
	provider, err := infer.NewProviderBuilder().
		...
		WithRepository("https://github.com/excavador/pulumi-netbird").
		WithPluginDownloadURL("github://api.github.com/excavador/pulumi-netbird").
		WithPublisher("excavador").
		WithLogoURL("https://raw.githubusercontent.com/excavador/pulumi-netbird/master/assets/logo.webp").
		...
		WithLanguageMap(map[string]any{
			...
			"go": map[string]any{
				...
				"importBasePath":                 "github.com/excavador/pulumi-netbird/sdk/go/netbird",
			},
			"nodejs": map[string]any{
				"packageName": "@excavador/pulumi-netbird",
