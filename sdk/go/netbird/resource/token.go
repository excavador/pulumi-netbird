...
// A NetBird personal access token (PAT) for a user.
type Token struct {
	...
	// Plain text representation of the generated token. Only available after creation.
	PlainToken pulumi.StringPtrOutput `pulumi:"plainToken"`
...
func NewToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.RegisterResource("netbird:resource:Token", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetToken(ctx *pulumi.Context,
	...
	var resource Token
	err := ctx.ReadResource("netbird:resource:Token", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// Date the token was created.
func (o TokenOutput) CreatedAt() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Token) pulumi.StringPtrOutput { return v.CreatedAt }).(pulumi.StringPtrOutput)
}

// User ID of the user who created the token.
func (o TokenOutput) CreatedBy() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Token) pulumi.StringPtrOutput { return v.CreatedBy }).(pulumi.StringPtrOutput)
}
...
// Date the token was last used.
func (o TokenOutput) LastUsed() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Token) pulumi.StringPtrOutput { return v.LastUsed }).(pulumi.StringPtrOutput)
}
...
// Plain text representation of the generated token. Only available after creation.
func (o TokenOutput) PlainToken() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Token) pulumi.StringPtrOutput { return v.PlainToken }).(pulumi.StringPtrOutput)
}
