...
func NewNetworkRouter(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("netbird:resource:NetworkRouter", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetNetworkRouter(ctx *pulumi.Context,
	...
	var resource NetworkRouter
	err := ctx.ReadResource("netbird:resource:NetworkRouter", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
